...
admsa ="u34a37ed1eb42be821ad1cfb4b768074b","u2b457b1ef8391ee451c9a22c835e1e33"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u34a37ed1eb42be821ad1cfb4b768074b","u2b457b1ef8391ee451c9a22c835e1e33":
                    if "join:" in msg.text:
...
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki3.updateProfile(profile)
                    ki3.sendText(msg.to,"􀜁??􏿿Update Names👉" + string + "â‡‡â‡‡👈")
#--------------------------------------------------------
