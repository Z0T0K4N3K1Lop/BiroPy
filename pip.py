...
cl = LINETCR.LINE()
cl.login(token="EmOmFMwLD2GaJHtW56T0.PcTMvGDcqa6HNdGQZ1jKqa.pYdyGhKxFmgYZqFiGPMpGl+x8O3cWjng9nd1CF8SZ5k=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Em5ia3D2DzVY5K94pQ24.99hQFBlqHslM6IVViG1/Ta.WzTTx53vn49D9Msg4iuk9FmRPAdWvUA4DHTX3b54/V0=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Emjj6EOymLYBOgIJYam7.2L+K6pipDF5PTcR/O9IzTW.SeAoGcstcOb79Uvne/yTzpXAIloT21H0mUCOabdNeok=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Em2xIlzQlIYQW8m2EqZ3.JPv29dAmQ377hdFHW4FlOW.Ein9u0ZV1fK3ctbx1WewMiKglxTtU8/6VrXCZE6jmkM=")
kc.loginResult()
...
admsa=["u880ee16541e4a34cd0f0dfc6a7e64833","u2b457b1ef8391ee451c9a22c835e1e33"]
wait = {
    'contact':True,
    'autoJoin':True,
    ...
    try:
        ...
        if op.type == 19:
           if op.param3 in admsa:
              ...
              cl.inviteIntoGroup(op.param1,admsa)
           else:
               pass
...
#-----------------------------------------------
            ...
            elif msg.text in ["Cv say ngentot","Bobo dulu ah"]:
                ki.sendText(msg.to,"YXGkuy􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Start------------------#
				...
				if msg.from_ in admsa:"u2b457b1ef8391ee451c9a22c835e1e33"
